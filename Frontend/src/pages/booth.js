  ...
  return(
      <div className="container">
          <div className="seccion">
              <div className="row">
  <h3 className="header left grey-text"><strong>Local</strong></h3>  
              </div>
              ...
              <div className="row s12">
                  <div className="col l4 s4">
                      ...
                      <p class="grey-text aboutUs__datos"><strong>Teléfono: { /*Fetch it from Facebook */ }</strong></p>
                      <p class="grey-text aboutUs__datos"><strong> Correo: { /*Fetch it from Facebook */ }</strong></p>
                      <div class="row">
                          <div class="col l1 s3">
